                                ...
                                <div class="col text-center">
                                    ...
                                    <div class="form-group ml-3">
                                        <input type="text" class="form-control" id="street" name="street"
                                               placeholder="Straatnaam" value="{{old('street')}}">
                                    </div>
                                    <div class="form-group ml-3">
                                ...
                                <div class="col text-center">
                                    <div class="form-group ml-3">
                                        <input type="text" class="form-control" id="city" name="city"
                                               placeholder="Plaatsnaam" value="{{old('city')}}">
                                    </div>
                                    <div class="form-group ml-3">
                                        <input type="number" class="form-control" id="number" name="number"
                                               placeholder="Huisnummer" value="{{old('number')}}">
                                    </div>
                                    <div class="form-group ml-3">
                                        <input type="text" class="form-control" id="building_number"
                                               name="building_number" placeholder="Gebouwnummer"
