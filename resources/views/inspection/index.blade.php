        ...
        <div class="px-4">
            <div class="bg-white overflow-hidden shadow-sm">
                <div class="p-4 bg-white border-b border-gray-200">
                    ...
                    <a href="{{URL::to('/inspection/create')}}" class="float-right btn border">
                            ...
                            @foreach ($inspections as $inspectie)
                                <div id = 'customer-field' class="row m-2 p-3 rounded border border-light shadow-sm bg-white">
                                    ...
                                    <div class="d-flex flex-column justify-content-end w-50 text-right pb-2">
                                        <a id="{{$inspectie->id}}" href="{{/*URL::to('/inspection/'.$inspection->id.'/details')*/ route('getInspectionEdit', $inspectie->id) }}">
